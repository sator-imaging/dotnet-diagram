...
generate_diagram() {
    ...
    puml-gen "$source_dir" "$temp_dir" -dir -allInOne \
      -createAssociation -excludePaths bin,obj,Properties $public_flag \
...
echo "Generated by [dotnet-diagram](https://github.com/sator-imaging/dotnet-diagram)" > "$README"
echo "" >> "$README"

echo "Generated by [dotnet-diagram](https://github.com/sator-imaging/dotnet-diagram)" > "$DIFF_MD"
echo "" >> "$DIFF_MD"
...
<body>
  <p>Generated by <a href="https://github.com/sator-imaging/dotnet-diagram">dotnet-diagram</a></p>
EOF
